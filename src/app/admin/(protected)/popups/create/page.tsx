  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Nouveau popup</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Créer un nouveau message popup pour les visiteurs
          </p>
        </div>
      </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Si renseigné, le bouton redirigera vers cette URL
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
              <p className="text-xs text-slate-500 mt-1">Plus la priorité est haute, plus le popup sera affiché en premier</p>
            </div>
            ...
            >
              ...
              {saving ? "Enregistrement..." : "Créer le popup"}
            </button>
          </div>
